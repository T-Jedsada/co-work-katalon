...
Mobile.setText(findTestObject('Register/edt/edt Pass'), '1234567890123456789012345678901234567890', 0)

Mobile.waitForElementPresent(findTestObject('Register/edt/edt RePass'), 0)

Mobile.setText(findTestObject('Register/edt/edt RePass'), '1234567890123456789012345678901234567890', 0)
