...
Mobile.waitForElementPresent(findTestObject('ForgotPassword/txt/txt Thanks '), 0)

Mobile.waitForElementPresent(findTestObject('ForgotPassword/txt/txt Please follow the link in the email'), 0)

Mobile.waitForElementPresent(findTestObject('ForgotPassword/txt/txt to reset your password'), 0)

Mobile.waitForElementPresent(findTestObject('ForgotPassword/btn Back to Login'), 0)

Mobile.tap(findTestObject('ForgotPassword/btn Back to Login'), 0)
