...
class Slack {
	...
	def notifyBeforeTestCase(TestCaseContext testCaseContext) {
		...
		slackMessage.setHttpBody('{"text": "Test Web UI : ' + testCaseContext.getTestCaseId()+ ': Running"}"')
		postToSlack()
	...
	def notifyAfterTestCase(TestCaseContext testCaseContext) {
		...
		slackMessage.setHttpBody('{"text": "Test Web UI : ' + testCaseContext.getTestCaseId() + ': ' + testCaseStatus + '"}"')
		postToSlack()
